...
from ..core.utils.models import Money, zero_money
...
class Order(ModelWithMetadata):
    ...
    billing_address = models.ForeignKey(
        CustomUser, related_name="+", editable=False, null=True, on_delete=models.SET_NULL
    )
    ...
    def _total_paid(self):
        ...
        total_paid = sum(total_captured, zero_money())
        return total_paid
    ...
    def get_subtotal(self):
        ...
        return sum(subtotal_iterator, zero_money())
