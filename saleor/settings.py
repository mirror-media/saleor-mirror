...
DEFAULT_COUNTRY = os.environ.get("DEFAULT_COUNTRY", "TW")
DEFAULT_CURRENCY = os.environ.get("DEFAULT_CURRENCY", "TWD")
...
ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,104.155.209.114"))
